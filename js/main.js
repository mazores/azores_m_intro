...
var vm = new Vue({
  ...
  methods: {
    logInOut() {
      ...
      // ? : is a ternary statement (shorthand for if/ese)
    ...
    // this is ES6 data destructuring - pull the keys and valuse you need, not the whole object
    loadMovie() {
